export const CONFIG = {
  ...
  authorWebsite: 'www.maliseet.org', // Put a link to your website or social media here
  wordListSource: 'Passamaquoddy-Maliseet Language Portal', // Describe the source material for your words here
  wordListSourceLink: 'pmportal.org', // Put a link to the source material for your words here
  //
