//import { solution, solutionIndex, tomorrow, solutionDefinition} from '../lib/words'
...
export const CONFIG = {
  ...
  //wordLength: 3, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  ...
  wordListSourceLink: 'https://www.pmportal.org', // Put a link to the source material for your words here
  //
